            ...
            <div className="absolute -bottom-5 -right-5 bg-white p-4 rounded-lg shadow-lg z-10 animate-fade-in">
              ...
              <div className="grid grid-cols-3 gap-4 mt-2">
                <div className="text-center">
                  <div className="text-2xl font-bold text-research-light-blue">7</div>
                  <div className="text-xs text-gray-500">Publications</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-research-light-blue">6+</div>
                  <div className="text-xs text-gray-500">Projects</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-research-light-blue">130+</div>
